              ...
              <form action="${pageContext.request.contextPath }/UpdateStu"  method = "POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type = "text" id = "stu_id" name = "stu_id" value = "${UPDATE_SESSION.stu_id }" class="form-control" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">姓名</label>
                    <input type = "text" id = "stu_name" name ="stu_name" value ="${UPDATE_SESSION.stu_name }" class="form-control" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">密码</label>
                    <input type = "text" id = "stu_pwd" name ="stu_pwd" value = "${UPDATE_SESSION.stu_pwd }" class="form-control" >
                  </div>
                </div>
                <!-- /.card-body -->
