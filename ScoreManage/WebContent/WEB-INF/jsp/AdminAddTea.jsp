              ...
              <form action="${pageContext.request.contextPath }/AddTeacher"  method = "POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type = "text" id = "teacher_id" name = "teacher_id" class="form-control" >
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type = "text" id ="teacher_pwd" name = "teacher_pwd" class="form-control" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">教学科目</label>
